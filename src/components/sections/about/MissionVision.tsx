  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className="absolute -top-32 right-0 w-150 h-125 rounded-full"
          style={{
            background:
              "radial-gradient(ellipse at 100% 0%,rgba(124,58,237,0.08) 0%,transparent 65%)",
          }}
        />
        <div
          className="absolute -bottom-24 -left-16 w-125 h-100 rounded-full"
          style={{
            background:
              "radial-gradient(ellipse at 0% 100%,rgba(167,139,250,0.07) 0%,transparent 65%)",
          }}
        />
      </div>
            ...
            <div className="relative z-10 flex flex-col flex-1">
              ...
              <div className="grid grid-cols-2 gap-2.5 mb-8">
                {FEATURES.map(({ icon: Icon, label, sub }) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[12px] font-bold text-white leading-none mb-0.5">
                        {label}
                      </p>
                      <p
              ...
              <div className="grid grid-cols-3 gap-2.5 mt-auto">
                {STATS.map(({ n, label }) => (
                  ...
                  >
                    <p
                      className="text-[22px] font-black text-white leading-none mb-0.5"
                      style={{
                        backgroundImage:
                          "linear-gradient(118deg,#a78bfa,#c4b5fd)",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                        backgroundClip: "text",
                      }}
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <span
                    style={{
                      backgroundImage:
                        "linear-gradient(118deg,#7c3aed 10%,#a78bfa 60%,#c4b5fd)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                    }}
                ...
                <p
                  ...
                  style={{ color: "#6b7280" }}
                >
                  We don't want to be the biggest agency — we want to be the one
                  founders call when it actually matters. Every project is
                  personal, every line of code is intentional.
                </p>
              </div>
            </motion.div>
